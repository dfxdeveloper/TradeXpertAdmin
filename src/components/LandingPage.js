  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      <div className="text-center relative z-10">
        ...
        <div className="flex flex-col gap-6 justify-center items-stretch w-full max-w-md mx-auto px-4 md:flex-row relative">
          <a 
            href="/add"
            className="flex items-center justify-center gap-3 bg-white text-purple-600 px-6 py-6 md:py-3 rounded-xl md:rounded-lg font-semibold shadow-lg hover:bg-gray-100 w-full no-underline touch-manipulation text-lg md:text-base active:scale-95 transition-transform"
          >
          ...
          <a 
            href="/manage"
            className="flex items-center justify-center gap-3 bg-transparent border-2 border-white text-white px-6 py-6 md:py-3 rounded-xl md:rounded-lg font-semibold hover:bg-white/20 w-full no-underline touch-manipulation text-lg md:text-base active:scale-95 transition-transform"
          >
